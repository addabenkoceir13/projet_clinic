  ...
  <div class="sidebar-scroll">
      ...
      <nav>
        <ul class="nav">
          ...
          <li><a href="history.php?id_patient=<?php echo $id_patient;?>&id_app=<?php echo $id_appo;?>" class="active"><i class="fa fa-history" aria-hidden="true"></i> <span>History Patient</span></a></li>
	...
	<div class="col-md-12">
        ...
        <div class="px-4 py-5 my-5 text-center">
          ...
          <p class="lead mb-4"> </p>
               ...
               <!-- Start Fulle Name patient -->
<!-- Start History treatement -->
  <h3 class="text-primary">History Treatement</h3><br>
     <table class="table table-striped">
      ...
      <!-- Start PHP **** -->
          <?php
	            $query = "SELECT * FROM `ordonnance` WHERE `nom_pat` = '$fname' AND `pre_pat` = '$lname' AND `group_id` = 1";
  ...
  <!-- End History treatement -->

<!-- Start History Analyse -->
<h3 class="text-primary">History Analyse</h3><br>
   <table class="table table-striped">
        <thead>
           <tr class="info">
           <th>ID Consultaion</th>
    ...
    <!-- Start PHP **** -->
        <?php
	          $query2 = "SELECT * FROM `ordonnance` WHERE `nom_pat` = '$fname' AND `pre_pat` = '$lname' AND `group_id` = 2";
...
<h3 class="text-primary">History Scan</h3><br>
    <table class="table table-striped">
     ...
     <!-- Start PHP **** -->
     <?php
	          $query2 = "SELECT * FROM `ordonnance` WHERE `nom_pat` = '$fname' AND `pre_pat` = '$lname' AND `group_id` = 3";
	          $result2 = mysqli_query($conn, $query2);
	             if(mysqli_num_rows($result2) > 0){
	          	  while($row = mysqli_fetch_assoc($result2)){
	          			  echo 
