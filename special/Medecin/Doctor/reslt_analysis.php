...
<div id="sidebar-nav" class="sidebar">
  <div class="sidebar-scroll">
      ...
      <ul class="nav">
          ...
          <li><a href="reslt_analysis.php?id_patient=<?php echo $id_patient;?>&id_app=<?php echo $id_appo;?>" class="active"><i class="fa fa-tint"></i> <span>Result Analyse</span></a></li>	
...
<h3 class="text-primary">History Analyse</h3><br>
   <table class="table table-striped">
    ...
    <!-- Start PHP **** -->
        <?php
	          $query2 = "SELECT resultaa.id,resultaa.id_cons,resultaa.resulta_analyse, resultaa.date ,ordonnance.nom_pat,ordonnance.pre_pat,ordonnance.id_cons 
            FROM resultaa
             INNER JOIN ordonnance ON resultaa.id_cons = ordonnance.id_cons WHERE nom_pat = '$fname' AND pre_pat = '$lname'";
	          $result2 = mysqli_query($conn, $query2);
	             if(mysqli_num_rows($result2) > 0){
                    ...
                    "<td>". $row["date"]."</td>".
                    "<td>";?><a target='_blank' href='confrme.php?id_analyse=<?php echo $row["id"] ; ?>'>View</a></td>
                <?php '</tr>';
	          					  }
