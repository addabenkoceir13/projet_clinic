					...
					<div class="panel panel-profile">
					   <div class="panel">
					      <div class="panel-body">
						     ...
						     <form action="Code PHP/modify/modify.php" method="POST" class="needs-validation" >
							 	<input style="font-size: 10px; width:0px; color:#fff; border: none;" type="text" name="IDSEC" value="<?php echo $id_med ;?>">
								<div class="form-row">
									<div class="col-md-6 mb-3">
										<label for="validationDefault01">First Name</label>
										<input type="text" class="form-control input-lg" name="fname" id="validationDefault01" value="<?php echo $row["nom_med"] ;?>" required>
									</div>
									  <div class="col-md-6 mb-3">
										<label for="validationDefault02">Last Name</label>
										<input type="text" class="form-control input-lg" name="lname" id="validationDefault02" value="<?php echo $row["pre_med"] ;?>" required>
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-6 mb-3">
									  <label for="validationCustom03">Birthday</label>
									  <input type="date" class="form-control input-lg" name="birthday" id="validationCustom03" value="<?php echo $row["date_med"] ;?>" required>
									</div>
								...
								<div class="form-row">
									<div class="col-md-6 mb-3">
										...
										<input type="text" class="form-control input-lg" name="email"  id="validationDefault03" value="<?php echo $row["email_med"] ;?>" required>
									  </div>
									<div class="col-md-6 mb-3">
									  <label for="validationCustom02">Phone</label>
									  <input type="tel" class="form-control input-lg" name="phone"  pattern="[0-9]{2}[0-9]{8}" value="<?php echo $row["tel_med"] ;?>" required>
									</div>
								</div>	
								<div style="margin-bottom: 30px;" class="col-md-6 mb-3">
									<label for="validationDefault03">Password</label>
									<input type="password" class="form-control input-lg" name="password"  id="validationDefault03" value="<?php echo $row["pssaword_med"] ;?>" required>
								</div> 
								  <div>
					  ...
					  <form action="Code PHP/modify/modify.php" method="POST" class="needs-validation" >
							...
							<div class="form-row">
								<div class="col-md-6 mb-3">
									...
									<input type="time" class="form-control input-lg" name="time_s" id="validationDefault01"  required>
								</div>
								  <div class="col-md-6 mb-3">
									<label for="validationDefault02">Expiry Time</label>
									<input type="time" class="form-control input-lg" name="time_e" id="validationDefault02" required>
								</div>
							</div>
							<div class="form-row">
								<h4>Days Working</h4>
