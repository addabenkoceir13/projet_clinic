...
<head>
	<title>Analysis Laboratory	</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.php" class="active"><i class="fa fa-flask"></i> <span>Laboratory</span></a></li>
						<li><a href="result.php" class=""><i class="fa fa-envelope-o"></i> <span>Analysis Result</span></a></li>
						<li>
							...
							<div class="panel">
								<div class="panel-heading">
									<div class="px-4 py-5 my-5 text-center">
										<h1 style="color: #0066ff;"><i class="fa fa-flask" ></i>Medical Analysis Laboratory</h1>
									</div>
									<h3 style="color: #005fff;"><i style="margin-right: 10px; font-size: 20px;" class="fa fa-list-ul" ></i>Liste Of Analyse</h3>
									<table class="table table-striped">
										...
										// WHERE 
											 $query = "SELECT * FROM `ordonnance` WHERE `date` = '$date_res' AND `group_id` = 2";
