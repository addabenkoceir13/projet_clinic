...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.php"><img style="width: 200px; " src="photo/top_head_layout.png" alt="Klorofil Logo" class="logo"></a>
			</div>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.php" class=""><i class="fa fa-heart-o"></i> <span>Scans</span></a></li>
						<li><a href="result.php" class="active"><i class="fa fa-envelope-o"></i> <span>Scans Result</span></a></li>
						<li>
						...
						<div class="col-md-12">
							<div class="panel">
								...
								<?php //include "include/uplodefile.php";?>
									<h3 class="panel-info">Please enter patient information to submit Scans</h3>
								</div>
								<div class="panel-body">
									<form action="include/uplodefile.php" method="POST" enctype="multipart/form-data">
										<div class="form-row">
											<div class="form-group col-md-4">
											  <input type="text" class="form-control input_style" name="id_cons" placeholder="Enter ID Consultation" required>
											</div>
							...
							<div class="panel-heading">
								...
								<table class="table table-striped">
									...
									<tr>
										...
										<th>Date Resulta</th>
										<th>View Scans</th>
										<th>download Scans</th>
    								  </tr>
    								</thead>
    								<tbody>
								<?php
									$sql = "SELECT resultab.id,resultab.id_cons,resultab.result_scan, resultab.date, ordonnance.id_cons, ordonnance.nom_pat,ordonnance.pre_pat 
									FROM resultab
									 INNER JOIN ordonnance ON resultab.id_cons = ordonnance.id_cons";
