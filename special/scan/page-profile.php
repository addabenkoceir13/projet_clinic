...
$sql4 = "SELECT * FROM `secretaire` WHERE `ID_sec` = '$id_sec'";
				...
				<div class="panel panel-profile">
					   <div class="panel">
					      <div class="panel-body">
						  	<h1 class="display-4">Hello, <?php echo $_SESSION['pre_sec']." ".$_SESSION['nom_sec'] ?></h1>
							  <h3 class="display-3">Do you Want to modify your profiler?</h3>
						     <form action="include/modify.php" method="POST" class="needs-validation" >
							 	<input style="font-size: 10px; width:0px; color:#fff; border: none;" type="text" name="IDSEC" value="<?php echo $id_sec ;?>">
								<div class="form-row">
