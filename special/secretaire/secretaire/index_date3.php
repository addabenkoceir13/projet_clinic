...
if (isset($_POST["date_rdv_app"])) {

    $date_today = $_POST["date_app"];
}
//  Morning
...
<html lang="en">
  ...
  <body>
  <a style="margin: 30px 50px; width: 100px;" href="appointment.php" class="btn btn-primary "> < Back</a>
<div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Cardiology' ";
...
<form action="" method="POST" class="row g-3 needs-validation" >
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Cardiology</h1>
     <strong>Note:</strong>
...
<button style="margin-top: 30px;" class="btn btn-primary btn-block" name="rdvpatient" type="submit" disabled >Make An Appointment</button>
...
<!-- 
 ...
 -->
 <div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Emergency Intensive Care'";
        $result = mysqli_query($conn, $sql);if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) { ?>
<form action="" method="POST" class="row g-3 needs-validation" >
<input type="hidden" name="id_sec" value="<?php echo $ID_sec; ?>">
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Emergency Intensive Care</h1>
     <strong>Note:</strong>
     The Frame in <span class="text-success">green</span>,The time is availble to everyone, But the <span class="text-danger" >red</span> frame has been reserved
    </div>
  <div class="row">
...
<!-- 
 ...
 -->
 <div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Radiology Specialized Medical imaging'";
        $result = mysqli_query($conn, $sql);if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) { ?>
<form action="" method="POST" class="row g-3 needs-validation" >
  <input type="hidden" name="id_sec" value="<?php echo $ID_sec; ?>">
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Radiology Specialized Medical imaging</h1>
     <strong>Note:</strong>
     The Frame in <span class="text-success">green</span>,The time is availble to everyone, But the <span class="text-danger" >red</span> frame has been reserved
    </div>
  <div class="row">
...
<!-- 
 ...
 -->
 <div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Vascular Medicine and Call Vascular'";
        $result = mysqli_query($conn, $sql);if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) { ?>
<form action="" method="POST" class="row g-3 needs-validation" >
<input type="hidden" name="id_sec" value="<?php echo $ID_sec; ?>">
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Vascular Medicine and Call Vascular</h1>
     <strong>Note:</strong>
     The Frame in <span class="text-success">green</span>,The time is availble to everyone, But the <span class="text-danger" >red</span> frame has been reserved
    </div>
  <div class="row">
...
<!-- 
 ...
 -->
 <div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Medical analysis laboratory'";
        $result = mysqli_query($conn, $sql);if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) { ?>
<form action="" method="POST" class="row g-3 needs-validation" >
<input type="hidden" name="id_sec" value="<?php echo $ID_sec; ?>">
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Medical analysis laboratory</h1>
     <strong>Note:</strong>
     The Frame in <span class="text-success">green</span>,The time is availble to everyone, But the <span class="text-danger" >red</span> frame has been reserved
    </div>
  <div class="row">
...
<!-- 
 ...
 -->
 <div style="margin-top: 50px;" class="container">
<?php $sql = "SELECT * FROM `rendez_vous` WHERE  `objt_rdv` = 'Dental Surgery'";
        $result = mysqli_query($conn, $sql);if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) { ?>
<form action="" method="POST" class="row g-3 needs-validation" >
<input type="hidden" name="id_sec" value="<?php echo $ID_sec; ?>">
  ...
  <div class="note">
  <h1 style="font-family: Open Sans', sans-serif;">Dental Surgery</h1>
