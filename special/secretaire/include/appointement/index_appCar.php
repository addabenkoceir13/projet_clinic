...
// *** Code PHP for table appoimntment cardiology ******************************************
   ...
   $query = "SELECT patent.ID_pat,patent.pre_pat, patent.nom_pat,rendez_vous.ID_RDv,rendez_vous.objt_rdv,rendez_vous.ID_sec, rendez_vous.date_rdv,patent.tel_pat
   FROM patent
   INNER JOIN rendez_vous ON patent.ID_pat = rendez_vous.ID_pat WHERE `objt_rdv` = 'Cardiology' AND `date_rdv2`= '$dateRdv'; ";
