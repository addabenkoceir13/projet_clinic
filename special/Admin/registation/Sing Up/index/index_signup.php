       ...
       <div class="heading">
        ...
        <form class="needs-validation form"  action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST" novalidate>
            <div class="form-row">
              ...
              <div class="col-md-12 mb-3">
                <input type="date" class="form-control" id="validationCustom02" name="birthday"  required>
                <div class="valid-feedback"> </div>
                <div style="float: left; margin-left:-130px;" class="invalid-feedback"> Please provide a valid Birthay.</div>
              </div>
              <div class="col-md-12 mb-3">
                <input type="tel" class="form-control" id="validationCustom02" name="phone" placeholder="Entre Your Phone" required>
                <div class="valid-feedback"> </div>
