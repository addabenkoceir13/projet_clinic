...
if (isset($_SESSION['ID_pat'])        && 
    isset($_SESSION['pre_pat'])       &&
    isset($_SESSION['nom_pat'])       && 
    isset($_SESSION["date_niss_pat"]) && 
    isset($_SESSION["email_pat"])     &&  
    isset($_SESSION["tel_pat"])       &&  
    isset($_SESSION["objt_rdv_pat"])  &&
    isset($_SESSION["date_rdv"])      &&
    isset($_SESSION["address_pat"])
      ) {
    $ID_pat = $_SESSION['ID_pat'];
}

$ID_pat2 = $_SESSION['ID_pat'];
...
$sql = "INSERT INTO rendez_vous SET ID_pat = '$id_pat' , `ID_sec` = 0 , objt_rdv = '$objt_rdv',  date_rdv = '$date_rdv', date_rdv2 = '$date_toda'"; 
...
$_SESSION['objt_rdv']  = $_POST["objet_rdv"];  
$_SESSION['date_rdv']  = $_POST["timerdvpat"]; 
...
<div  class="jumbotron jumbotron-fluid box-1">
  <div class="container ">
  <h1 class="box-text hed1 text-primary"><i class="fa fa-list-alt" ></i>Your Personal Information</h1> 
    <div class="row box-3">
      <div class="col-md-4">
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>First Name:</strong>  <?php echo $_SESSION['pre_pat'] ?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>Birthday:</strong>    <?php echo $_SESSION["date_niss_pat"]?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>Phone:</strong>       <?php echo $_SESSION["tel_pat"]?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>The Service:</strong> <?php echo $objt_rdv ?></p>
      </div>
      <div class="col-md-6">
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>Last Name:</strong>    <?php echo $_SESSION["nom_pat"] ?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>Address:</strong>      <?php echo $_SESSION["address_pat"] ?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>Email:</strong>        <?php echo $_SESSION["email_pat"] ?></p>
          <p class="box-text"><i class="fa fa-check-circle-o"></i><strong>The Date Appointment:</strong>  <?php echo $date_today ?> </p>
      </div>
    </div>
  <h1 class="box-text hed2 text-primary"><i class="fa fa-calendar-check-o" ></i>Please Choose The Time You Would Like To Schedule Your Appointment</h1>
...
<form action="" method="POST" class="row g-3 needs-validation" >
  <input type="hidden" name="id_pat" value="<?php echo $ID_pat2; ?>">
